...
<section class="">
    <div class="content p-4">
        <div class="row pt-3">
            <div class="col-md-6">
                <h3 class=""><?php echo trans('lang.assetstatus_list');?></h3>
            </div>
            <div class="col-md-6 text-md-right pb-md-0 pb-3">
            @if (count(app('userAccess')('ASSETSTATUS_ADD')) > 0)
                ...
                <form action="#" id="formadd">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input name="order" type="number" step="1" id="order" class=" form-control" required placeholder="<?php echo trans('lang.order');?>"/>
                        </div>
                        <div class="form-group">
    ...
    <!--edit new data -->
    @if (count(app('userAccess')('ASSETSTATUS_EDIT')) > 0)
    ...
    <!--delete data -->
    @if (count(app('userAccess')('ASSETSTATUS_DELETE')) > 0)
