...
<section class="">
    <div class="content p-4">
        <div class="row pt-3">
            <div class="col-md-6">
                <h3 class=""><?php echo trans('lang.status_list');?></h3>
            </div>
            <div class="col-md-6 text-md-right pb-md-0 pb-3">
            @if (count(app('userAccess')('STATUS_ADD')) > 0)
    ...
    <!--edit new data -->
    @if (count(app('userAccess')('STATUS_EDIT')) > 0)
    ...
    <!--delete data -->
    @if (count(app('userAccess')('STATUS_DELETE')) > 0)
...
$('#edit').on('show.bs.modal', function(e) {
	...
	$.ajax({
		...
		success: function(data) {
            ...
            $("#editcolor").val(data.message.color);
